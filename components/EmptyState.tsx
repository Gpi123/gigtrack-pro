  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      <div className="bg-[#24272D] border border-[#31333B] rounded-3xl p-8 mb-6 max-w-md">
        ...
        <button
          onClick={onAddClick}
          className="w-full px-6 py-3 bg-[#3057F2] hover:bg-[#2545D9] text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#3057F2]/20"
        >
          <Plus size={20} />
          Criar Primeiro Show
        </button>
